...
class MiScroll(ttk.Scrollbar):
    ...
    def _config_MiScroll(self):
        ...
        #self.ss.layout(
        #    f'{self.estilo}.Vertical.TScrollbar',
        #    [('TScrollbar.trough', {'sticky': 'wens'})] +
        #    [('TScrollbar.thumb', {'sticky': 'wens'})]
        #)
        # "-shape": must be -side, -sticky, -expand, -border, -unit, or -children
        #self.config(style=f'{self.estilo}.Vertical.TScrollbar')
        self.config(style=f'Vertical.TScrollbar')
